        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        ...
                        <a href="hoa-don-list.php"><button class="btn btn-danger">Danh sách đơn hàng</button></a>
                                  ...
                                  <td><a href="../mail/lesson-7/lesson-7/index.php?ma_hd=<?=$ma_hd?>&ma_kh<?=$ma_kh?>"><button class="btn btn-succes" style="background-color:#5cb85c; color:#fff; float: right;">Send mail</button></a></td>
		</div>
            </div>
         <!-- /. PAGE WRAPPER  -->
        </div>
