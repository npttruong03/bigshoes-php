...
define("SMTP_UNAME", "phuctruong03qt@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "cudcciwrikjsxqbf"); //Password for SMTP authentication
