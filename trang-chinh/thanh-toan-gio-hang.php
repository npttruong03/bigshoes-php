        ...
        <input type="text" class="form-control" id="" name="ma_kh" value="<?=$ma_kh?>" hidden>
            ...
            <?php
                ...
                try {
                    ...
                    // Câu SQL Insert
                    $sql = "INSERT INTO hoa_don(ngay_mua,ghi_chu,ma_kh,email) 
                            VALUES ('".$ngaymua."','".$ghi_chu."','".$ma_kh."','".$email."')";
                    ...
                    foreach($items as $item){
                        extract($item);
                        $sql = "INSERT INTO hoa_don_chi_tiet(ma_hd,ma_hh,so_luong,don_gia,email) VALUES ('".$ma_hd."','".$ma_hh."','".$sl."','".$price."','".$email."')";
                        $conn->exec($sql);
