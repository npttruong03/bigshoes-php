...
">
    ...
    <div class="container" style="padding-left: 0px;margin-top: 42px;">
        <div class="row">
            <div class="col-md-3">
                <!-- ---------------------
                --------------------------- -->
                    ...
                    <div class="row" style="margin-top: 35px;">
                        ...
                        <ul class="list-group">
                            ...
                            <?php foreach($items as $item){
                                extract($item);
                                ?>
                            <a href="tt-cung-loai.php?ma_loai=<?=$ma_loai?>"><li class="list-group-item" style="color:#000;"><?=$ten_loai?></li></a> 
                            <?php } ?>
                        </ul>
            ...
            <div class="col-md-9">
                <!-- <div class="row"> -->
                    ...
                    <!-- code php danh sách tin tức -->
                    <?php
                    require_once ('../admin/dao/tin-tuc.php');
                    $items = tin_tuc_select_all_chu_de();
                ...
                <a href="chi-tiet-tt.php?ma_tt=<?=$ma_tt?>"><span class="chi-tiet">CHI TIẾT</span></a>
                   
                    <a href="chi-tiet-tt.php?ma_tt=<?=$ma_tt?>"><img  src="../../bigshoes/css/tin-tuc/img/<?=$hinh?>" alt="" class="img"><span class='hang-moi'>Tin Nóng</span></a>
                    <div class="glow-wrap">
    <i class="glow"></i>
  </div>
                    <div class="text">
                        ...
                        <hr>
                        <div class="price" style="color: #808080;">
                            <i><?=substr($noi_dung,0,50)?>...</i>
                        </div>
                    </div>
                </div>
                <?php } ?>
